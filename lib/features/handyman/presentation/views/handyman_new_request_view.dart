      ...
      child: Column(
        ...
        children: [
          ...
          _DetailRow(
            ...
            value: '${job.scheduledDate.day.toString().padLeft(2,'0')}/'
        ...
        children: [
          ...
          _AnimatedActionButton(
            ...
            onTap: () => showAnimatedConfirmDialog(
              ...
              confirmColor: teal,
              onConfirm: () {
                context.read<HandymanCubit>().updateJobStatus(
                  requestId,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<HandymanCubit, HandymanState>(
      ...
      builder: (context, state) {
        ...
        if (state is HandymanJobDetailsLoaded) {
          final job = state.job;
              ...
              child: Stack(
                children: [
                  ...
                  CustomScrollView(
                    slivers: [
                      SliverToBoxAdapter(
                        child: animated(
                          0,
                          buildHeader(context, isDark, l10n, textTheme, colorScheme,job),
                        ),
                      ),
                      SliverToBoxAdapter(
                        child: animated(
                          1,
                          buildCustomerCard(isDark, l10n, textTheme, colorScheme,job),
                        ),
                      ),
                      SliverToBoxAdapter(
                        child: animated(
                          2,
                          buildServiceDetails(isDark, l10n, textTheme, colorScheme,job),
                        ),
                      ),
                      SliverToBoxAdapter(
                        child: animated(
                          3,
                          buildDescription(isDark, l10n, textTheme, colorScheme,job),
                        ),
                      ),
                      SliverToBoxAdapter(
                  ...
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: animated(5, buildActionBar(context, isDark, l10n,requestId)),
                  ),
                ],
              ),
            ),
        ...
        // Handles HandymanMessage, Initial, etc.
        return const Scaffold(
