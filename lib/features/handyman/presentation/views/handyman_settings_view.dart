...
abstract class _SettingsBase<T extends StatefulWidget> extends State<T>
  ...
  // ── Work hours section ────────────────────────────────────
  Widget buildAppearanceSection(bool isDark, AppLocalizations l10n) {
  ...
  Widget buildRemeberMe(bool isDark, AppLocalizations l10n) {
    return buildSection(
        isDark: isDark,
        textTheme: Theme.of(context).textTheme,
        ...
        child: _ToggleRow(
            title: l10n.rememberMe,
            subtitle: 'اغلاق و فتح تذكر الحساب',
          ...
          children: [
            CustomScrollView(
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: animated(5, buildAppearanceSection(isDark, l10n)),
                ),



                SliverToBoxAdapter(
                  child: animated(5, buildRemeberMe(isDark, l10n)),
                ),
                //
                // SliverToBoxAdapter(
                //   child: animated(6, buildAvailability(isDark, l10n)),
                // ),
                  ...
                  Expanded(
                    child: CustomScrollView(
                      slivers: [
                        ...
                        SliverToBoxAdapter(
                          child: animated(3, buildAppearanceSection(isDark, l10n)),
                        ),
                        SliverToBoxAdapter(
                          child: animated(4, buildNotifications(isDark, l10n)),
                        ),
